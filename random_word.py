...
# todo start from certain index (and stop at certain)
...
def parse_dict_path(language):
    dict_file_name = f'{language}.txt'
    return os.path.join(dicts_path, dict_file_name)


if __name__ == "__main__":
    args = parse_args()
    dict_path = parse_dict_path(args.language)
